...
export default function PaymentSection({
    ...
    const initializePayment = async () => {
        ...
        try {
            ...
            const payload = {
                flightInstanceIds,
                flightInstances: flightInstances.map(f => ({
                    flightInstanceId: f.flightInstanceId || f._id,
                    flightNumber: f.flightNumber,
                    airlineName: f.airlineName,
                    airlineLogo: f.airlineLogo,
                    sourceAirportId: f.sourceAirportId,
                    sourceAirportCode: f.sourceAirportCode,
                    sourceAirportCity: f.sourceAirportCity,
                    sourceAirportCountry: f.sourceAirportCountry,
                    destinationAirportId: f.destinationAirportId,
                    destinationAirportCode: f.destinationAirportCode,
                    destinationAirportCity: f.destinationAirportCity,
                    destinationAirportCountry: f.destinationAirportCountry,
