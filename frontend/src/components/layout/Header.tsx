  ...
  return (
    <header className="w-full bg-white border-b border-gray-100 px-6 py-3">
      <div className="flex items-center gap-4">
        ...
        {/* ── Page Title ── */}
        <h1 className="text-xl font-bold text-gray-900 tracking-tight shrink-0 min-w-[120px]">
          {title}
        </h1>
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <Dropdown>
            <Dropdown.Trigger>
              <div className="flex items-center gap-2.5 pl-1 pr-2 py-1.5 rounded-xl hover:bg-gray-50 transition-colors group">
                {/* Avatar */}
