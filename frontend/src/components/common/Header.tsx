                ...
                <div className="h-18 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-12 text-white">
                        ...
                        <Dropdown>
                            ...
                            <Dropdown.Popover className="bg-amber-100">
                                <Dropdown.Menu>
                        ...
                        <Dropdown>
                            ...
                            {userEmail ? <Dropdown.Popover className="bg-amber-100">
                                ...
                                <Dropdown.Menu>
                                    <Dropdown.Item>
                                        <Link href="/profile" className="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 rounded-lg cursor-pointer">
                                            <FaRegUser />
                                            Profile
                                        </Link>
                                    </Dropdown.Item>
                    ...
                    <div className='md:hidden'>
                        <Dropdown>
                            ...
                            {userEmail ? <Dropdown.Popover className="bg-amber-100 w-fit">
                                <div className="px-3 pt-3 pb-1">
                                    <div className="flex items-center gap-2">
                                        <Avatar size="sm">
                                            {userAvatar ? (
                                        ...
                                        <div className="flex flex-col gap-0">
                                            <p className="text-sm leading-5 font-medium">{userName}</p>
                                            <p className="text-xs leading-none text-muted">{userEmail?.slice(0, 21)}...</p>
                                        </div>
                                    </div>
                                </div>
                                <Dropdown.Menu>
                                    <Dropdown.Item className='flex items-center gap-2 px-3 py-2 text-sm text-gray-700 rounded-lg hover:bg-gray-50 cursor-pointer'>
                                        <Dropdown className='w-full'>
                                            <Dropdown.Trigger>
                                                <div className="flex w-full items-center px-3 py-2 gap-2 text-md font-medium hover:opacity-80">
                                                    <PiPhone /> Contact Us
                                                </div>
                                            </Dropdown.Trigger>
                                            <Dropdown.Popover className="bg-amber-100 w-full">
                                                <Dropdown.Menu>
                                                    <Dropdown.Item className="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 rounded-lg hover:bg-gray-50 cursor-pointer">
                                                        <MdEmail />
                                                        <a href="mailto:work.akshgupta@gmail.com">
                                        ...
                                        <Dropdown.Item className='flex items-center gap-2 px-3 py-2 text-sm text-gray-700 rounded-lg hover:bg-gray-50 cursor-pointer'>
                                            <Dropdown className='w-full'>
                                                <Dropdown.Trigger>
                                                    ...
                                                    <div className="flex items-center gap-2 text-md font-medium hover:opacity-80">
                                                        <PiPhone /> Contact Us
                                                    </div>
                                                </Dropdown.Trigger>
                                                <Dropdown.Popover className="bg-amber-100 w-full">
