...
export const PRIVATE_ROUTES = ["/dashboard", "/bookings", "/flights", "/payments", "/profile"];
...
export const DEFAULT_AUTHED_REDIRECT = "/dashboard";  // where to send already-logged-in users